      ...
      <div class="offcanvas-body">
        ...
        <c:if test="${userVO.type eq 'S'}">
          ...
          <c:choose>
			<c:when test="${ empty userVO }">
          <li class="nav-item">	
            <a class="nav-link active m-3" aria-current="page" href="/Misson-Web/jsp/member/JoinForm.jsp">회원가입</a>
          </li>
          <li class="nav-item">	
          ...
          <li class="nav-item">	
            <a class="nav-link active m-3" aria-current="page" href="/Misson-Web/jsp/member/MemberReference.jsp">마이페이지</a>
          </li>
          <li class="nav-item">	
            <a class="nav-link active m-3" aria-current="page" href="/Misson-Web/jsp/login/logout.jsp">로그아웃</a>
          </li>
          <li class="nav-item">
          	<div class="nav-link active m-3">
       	<c:if test="${not empty userVO}">
			[${userVO.name}님이 접속하였습니다]
		</c:if>
			</div>
